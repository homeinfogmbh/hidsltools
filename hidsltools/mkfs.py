...
def mkvfat(
    device: Path, *, label: str | None = None, fat_size: int = 32, verbose: bool = False
) -> None:
...
def mkext4(device: Path, *, label: str | None = None, verbose: bool = False) -> None:
...
def mkfs(
    device: Path, filesystem: Filesystem, *, verbose: bool = False, **kwargs
) -> None:
